...
#                 print("log")
            ...
            if (timer) % T2 == 0 or math.floor(perf_counter() - noDataStartTime) % 10 == 0: # Aktywowanie flagi w czasie T2
                flagSave2TXT = 1
#                 print("txt")
                
#             if timer % T3 == 0: # Aktywowanie flagi w czasie T3 lub w przypadku braku danych do odczytu w czasie 10s
#                 flagConnectSSH = 1
#                 print("ssh")
