...
#                 print("Ramka nieprawidlowa - niepoprawna dlugosc ramki")
        else:
            checksum = -1 # Ramka nieprawidlowa
#             print("Ramka nieprawidlowa - brak CR")
    ...
    # Znak /r
        ...
        if (bitCnt - 6) % 4 == 0:
            ...
            checksum = -1
#             print("Ramka nieprawidlowa - niepoprawna dlugosc danych ramki przed znakiem CR")
